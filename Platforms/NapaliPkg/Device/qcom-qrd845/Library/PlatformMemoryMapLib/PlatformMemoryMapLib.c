...
static ARM_MEMORY_REGION_DESCRIPTOR_EX gDeviceMemoryDescriptorEx[] = {
    ...
    /* DDR Regions */
    /* RAM Entry: Base 0x0000000080000000   Size 0x00000000C0000000 */
    /* RAM Entry: Base 0x0000000140000000   Size 0x00000000BD3A0000 */
    //--------------------- DDR  -----
    { "RAM Partition",     0x80000000, 0x05700000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    ...
    { "Removed Region",    0x85FC0000, 0x00020000, AddMem, SYS_MEM, SYS_MEM_CAP, Reserv, WRITE_BACK_XN },
    ...
    { "Removed Region",    0x86200000, 0x04900000, NoHob,  SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE },
    { "TGCM",              0x8AB00000, 0x01400000, NoHob,  SYS_MEM, SYS_MEM_CAP, Reserv, NS_DEVICE },
    ...
    { "RAM Partition",     0x0A0000000, 0xA0000000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
    { "RAM Partition",     0x140000000, 0xbd3a0000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv, WRITE_BACK_XN },
